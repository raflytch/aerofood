		...
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary"
					href="./index.php?page=new_evaluation"><i class="fa fa-plus"></i> Tambah Penilaian Baru</a>
			</div>
		</div>
		<div class="card-body">
				...
				<thead>
					<tr>
						...
						<?php if ($_SESSION['login_type'] != 1): ?>
							<th>Penilai</th>
						<?php endif; ?>
						<th width="15%">Rata-rata Performa</th>
						<th>Action</th>
					</tr>
				</thead>
				<tbody>
						...
						<tr>
							...
							<td class="text-center">
								...
								<div class="dropdown-menu" style="">
									<a class="dropdown-item view_evaluation" href="javascript:void(0)"
										data-id="<?php echo $row['id'] ?>">View</a>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item"
										href="./index.php?page=edit_evaluation&id=<?php echo $row['id'] ?>">Edit</a>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item delete_evaluation" href="javascript:void(0)"
