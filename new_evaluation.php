			...
			<form action="" id="manage_evaluation">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="row " id="ratings-field" style="display: none">
							<div class="col-md-12">
								<label for="" class="control-label">Penilaian</label>
							</div>
							<hr>
							<div class="col-md-6">
								<div class="form-group">
									<label for="" class="control-label">Efisiensi</label>
									<select name="efficiency" id="efficiency" class="form-control form-control-sm"
										required>
										<?php
										for ($i = 5; $i >= 0; $i--):
											?>
											<option <?php echo isset($efficiency) && $efficiency == $i ? "selected" : '' ?>>
												<?php echo $i ?>
											</option>
										<?php endfor; ?>
									</select>
								...
								<div class="form-group">
									<label for="" class="control-label">Ketepatan Waktu</label>
									<select name="timeliness" id="timeliness" class="form-control form-control-sm"
										required>
										<?php
										for ($i = 5; $i >= 0; $i--):
											?>
											<option <?php echo isset($timeliness) && $timeliness == $i ? "selected" : '' ?>>
												<?php echo $i ?>
											</option>
										<?php endfor; ?>
									</select>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="" class="control-label">Kualitas</label>
									<select name="quality" id="quality" class="form-control form-control-sm" required>
										<?php
										for ($i = 5; $i >= 0; $i--):
											?>
											<option <?php echo isset($quality) && $quality == $i ? "selected" : '' ?>>
												<?php echo $i ?>
											</option>
										<?php endfor; ?>
									</select>
								...
								<div class="form-group">
									...
									<select name="accuracy" id="accuracy" class="form-control form-control-sm" required>
										...
										for ($i = 5; $i >= 0; $i--):
											?>
											<option <?php echo isset($accuracy) && $accuracy == $i ? "selected" : '' ?>>
												<?php echo $i ?>
											</option>
										<?php endfor; ?>
									</select>
					...
					<div class="col-md-6">
						<div id="post-field">
							<div>
								<center><i>Pilih Pekerjaan</i></center>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button class="btn btn-secondary" type="button"
						onclick="location.href = 'index.php?page=evaluation'">Cancel</button>
				</div>
			</form>
		</div>
	</div>
